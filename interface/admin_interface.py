...
def admin_interface(all_halls:list[list], all_films:list[str], admin_password:str)->tuple[list[list], list[str], str, Literal[1,-10]]:
    while True:
        print("\n")
...
-10 - Apagar\n""")
        ...
        admin_input = custom_input('opcion: ', int, error_message="Opcion invalida.",
            validator=lambda option: ("Opcion invalida.", None) if not (option in options_tuple) else (None, option))
