...
def run_ticket_purchase_interface(
    ...
    available_seats = sum(row.count(SEAT_ICON) for row in hall)
...
def offer_consecutive_seats(
    hall: CinemaHall, seat_positions: list[tuple[int, int]], ticket_count: int
) -> bool:
