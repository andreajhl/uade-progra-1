...
from tools.seats.index import count_free_seats, maximum_consecutive_in_matrix
...
Sala \t Pelicula \t Espacios \t Espacios consecutivos maximos"""
    ...
    for hall_index in halls_indexes:
        ...
        print(f"{hall_index+1} \t {all_films_names[hall_index]} \t {total_free_seats}/{total_number_of_available_seats} \t {maximum_consecutive_in_matrix(all_halls[hall_index], SEAT_ICON)}")
    print()